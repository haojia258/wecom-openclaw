...
const REGISTRY = {
  ...
  '/技能': { file: '../commands/skill-command',  aliases: ['/skill', '/技能列表', '/skills'] },
  '/活动':     { file: '../commands/activity-agent-command', aliases: ['/活动 agent', '/活动 智能建议', '/activity', '/推广活动', '/活动查询', '/大促'] },
  ...
  '/底座':     { file: '../commands/foundation-command', aliases: ['/foundation', '/基建'] },
  ...
  '/周报':     { file: '../commands/kpi-command', aliases: ['/weekly', '/KPI', '/kpi'] },
